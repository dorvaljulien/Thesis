...
If $E<0$, they are bound and locked in a binary system. Such systems are characterised by their semi-major axis $a$, their eccentricity $e$, their period $p$, their total mass $m_t = m_1 + m_2$ and their mass ratio $q = m_2/m_1$ with $m_1$ being the primary, more massive than $m_2$.
