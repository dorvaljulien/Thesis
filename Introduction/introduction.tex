...
\subsubsection{From gas to stars}
...
\subsubsection{Substructure and early dynamical evolution}
...
\subsubsection{Star formation efficiency and infant mortality}
...
Finally, most of the previously mentionned simulations assumed a relaxed embedded stellar system. However, as mentionned in previous section, star formation is substructured. Dynamical evolution occurs
on timescales comparable to gas expulsion, making the stellar spatial distribution of huge importance for survival, as shown by \cite{Farias2015}.

\subsection{Initial conditions for simulations}

\subsubsection{Hydrodynamical simulations}
\subsubsection{Artificial substructure}
